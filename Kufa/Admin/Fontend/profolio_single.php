            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-10">
                        ...
                        <img src="../uplods/profile/works/<?= $work['work_image'] ?>" alt="img">
                            </div>
                            ...
                            <div class="avatar-post mt-70 mb-60">
                                <ul>
                                    <li>
                                        ...
                                        <img style="height: 80px ; width: 80px; ;" src="../uplods/profile/<?= $links['profile_pic'] ?>" alt="img">
                                        </div>
                                        <div class="post-avatar-content">
                                            <h5><?= $links['name'] ?></h5>
                                            <p><?= $work['work_heading'] ?></p>
                                            <div class="post-avatar-social mt-15">
                                                <a href="<?= $links['facebook'] ?>" target="blank"><i class="fab fa-facebook-f"></i></a>
                                                <a href="<?= $links['twitter'] ?>" target="blank"><i class="fab fa-twitter"></i></a>
                                                <a href="<?= $links['instagram'] ?>" target="blank"><i class="fab fa-instagram"></i></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
