...
$id = $_SESSION['auth_id'];
$links_query = "SELECT * FROM admins WHERE id = '$id'";
    ...
    <header>
        ...
        <div class="extra-info">
            ...
            <div class="social-icon-right mt-20">
                ...
                <a href="<?= $links['twitter'] ?>" target="_blank"><i class="fab fa-twitter"></i></a>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Will <?= $links['name'] ?></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.6s">I'm Will <?= $links['name'] ?>, professional web developer with long time experience in this field​.</p>
                            <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">

                                <ul>
                                    <li><a href="<?= $links['facebook'] ?>" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                        <div class="banner-img text-right">
                            <img src="../uplods/profile/<?= $links['profile_pic'] ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-4 col-md-6 pitem">
                                <div class="speaker-box">
                                    <div class="speaker-thumb">
                                        <img style="height: 500px; ; width: 415px; ;" src="../uplods/profile/works/<?= $work['work_image'] ?>" alt="img">
                                    </div>
                                    <div class="speaker-overlay">
                                        <span><?= $work['work_title'] ?></span>
                                        <h4><a href="./profolio_single.php?id=<?= $work['id'] ?>"><?= $work['work_heading'] ?></a></h4>
                                        <a href="./profolio_single.php?id=<?= $work['id'] ?>" class="arrow-btn">More information <span></span></a>
                                    </div>
                                </div>
                            </div>
                        <?php
            ...
            <div class="container">
                <div class="fact-wrap">
                    <div class="row justify-content-between">
                        ...
                        <?php
                        $facts_query = "SELECT * FROM facts WHERE facts_status='active' LIMIT 4";
                        ...
                        foreach ($facts_query_db as  $facts) : ?>
                            <div class="col-xl-2 col-lg-5 col-sm-5">
                                <div class="fact-box text-center mb-50">
                                    <div class="fact-icon">
                                        <i class="<?= $facts['facts_icon'] ?>" fs-5></i>
                                    </div>
                                    <span>
                                        <h3><span class="count"><?= $facts['facts_count'] ?></span></h3>
                                    </span>
                                    <span><?= $facts['facts_title'] ?></span>
                            ...
                            foreach ($testi_query_db as  $testi) : ?>
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img style="height: 150px; width: 150px;" src="../uplods/profile/works/<?= $testi['image'] ?>" alt="img">
                                    </div>
                    ...
                    foreach ($brand_query_db as  $brand) : ?>
                        <div class="col-xl-2 p-5">
                            <div class="single-brand">
                                <img style="height: 80px; width:130px ;" src="../uplods/profile/<?= $brand['brand_logo'] ?>" alt="img">
                            </div>
                        </div>
                    <?php
                    endforeach
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="contact-content">
                            ...
                            <div class="contact-list">
                                <ul>
                                    <li><i class="fas fa-map-marker"></i><span>Address :</span><?= $links['address'] ?></li>
                                    <li><i class="fas fa-headphones"></i><span>Phone :</span><?= $links['phone_number'] ?></li>
                                    <li><i class="fas fa-globe-asia"></i><span>e-mail :</span><?= $links['email'] ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="contact-form">
                            <form action="../Auth/contect.php" method="POST">
