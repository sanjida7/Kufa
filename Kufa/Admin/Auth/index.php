...
<div class="app-content">
    <div class="content-wrapper">
        <div class="container">
            ...
            <div class="row">
                <?php
                $users_query = "SELECT id,name,email FROM admins LIMIT 6";
                ...
                ?>
                <div class="col-xl-6">
                    <div class="card widget widget-list" style="height:450px; overflow-y: scroll;">
                        <div class="card-header">
                            <h5 class="card-title">Active Users<span class="badge badge-success badge-style-light"><?= $total_users_count['total'] ?></span></h5>
                        </div>
